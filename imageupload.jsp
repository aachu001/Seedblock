...
Computing</h1>
  ...
  <div id="content">
    ...
    <blockquote><h2>Wlecome:<% String namew=(String)session.getAttribute("name");
      ...
      <td width="400"><form name="s" method="post" enctype="multipart/form-data" action="imageupload2.jsp" onSubmit="return valid()">
          <table align="center"  width="350">
            <tr> 
              <td width="50"></td>
              <td> <strong><em><font color="#990000" size="+1" face="Times New Roman"  
	  style="text-decoration:underline">Upload Image</font></em></strong> </td>
            </tr>
            <tr> 
              <td><font face="Times New Roman"  size="+1"><strong>Image Id</strong></font></td>
              <td><input type="text" id="id" class="a" name="id" value="<%= (int) (Math.random() * 1000) %>" /></td>
            </tr>
            <tr> 
              <td><font face="Times New Roman"  size="+1"><strong>Image Name</strong></font></td>
              <td><input type="text" id="key1" name="key1"> </td>
            </tr>
           <tr>
	<td>
	<font color="red" size="+1">Choose File:*</font>
	</td>
	<td>
	<input type="file" id="userImage" name="image" style="width:100%" onchange="readURL(this);" > <img id="img_prev" src="#" alt="your image" />
