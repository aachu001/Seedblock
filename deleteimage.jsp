...
String subject ="Recover image id";

String messageText ="image id is=<b>"+id+"</b>";
...
PreparedStatement ps=con.prepareStatement("delete from imageupload  where imageid='"+id+"'");
ps.executeUpdate();
