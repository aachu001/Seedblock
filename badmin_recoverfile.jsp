...
Computing</h1>
  ...
  <div id="leftnav">
    ...
    <div id="nav">
      <ul id="navlist">
          <li><a href="badmin_recoverfile.jsp" class="top_parent">File Recover Request</a> </li>
       <li><a href="badmin_recoverimage.jsp" class="top_parent">Image Recover Request</a> </li>
...
PreparedStatement ps=con.prepareStatement("select fileid,userid from recoverfile where status='"+x+"'");
...
PreparedStatement ps11=con11.prepareStatement("select fname from fileupload1 where fid='"+s+"'");
...
while(rs11.next())
 ...
 %>
		  ...
		  <td bgcolor="#FFFFCC"> 
             ...
             <td bgcolor="#FFFFCC">  <a href="badmin_recoverfile1.jsp?<%=s%>"><font color="#0000000">Send File to User</font></a></td>
