...
String strQuery = "select id from imageupload where id='"+a+"'";
...
<input type="image" src="images.jsp?imgid=<%=rs.getInt(1)%>" width="200" height="200" alt="Submit">

 <br>
 <a href="imagedownload.jsp?<%=rs.getInt(1)%>">Download</a>
