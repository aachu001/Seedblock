...
Computing</h1>
  ...
  <div id="content">
    ...
    <blockquote><h2>Wlecome:<% String namew=(String)session.getAttribute("name");
      ...
      <table border="1">
          <tr> 
           <td bgcolor="#990000"><font color="#FFFFFF" size="+1">Image Name</font></td>
            <td bgcolor="#990000"><font color="#FFFFFF" size="+1">Image Id</font></td>
...
PreparedStatement ps=con.prepareStatement("select imagename,imageid,id from imageupload where uid='"+x+"'");
		  ...
		  <td bgcolor="#FFFFCC"> 
             <font color="#0000000"><%=s%></font>
              ...
              <font color="#0000000"><%=s1%></font>
				  ...
				  <td bgcolor="#FFFFCC">  <a href="viewimage1.jsp?<%=s2%>"><font color="#0000000">Click</font></a></td>
				   <td bgcolor="#FFFFCC">  <a href="deleteimage.jsp?<%=s1%>"><font color="#0000000">Click</font></a></td>
          </tr>
          <%
